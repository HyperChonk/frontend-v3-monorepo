...
import { bn, fNum, isZero } from '@repo/lib/shared/utils/numbers'
            ...
            <BalAlert
              content={
                <Text color="font.dark" fontSize="sm">
                  ...
                  {` to get veBAL. This is the special HyperChonk protocol liquidity pool. Come back to this step once you have acquired some of these LP tokens by adding liquidity to the `}
                  <BalAlertLink
                    fontSize="sm"
                    href="/pools/ethereum/v2/0x5c6ee304399dbdb9c8ef030ab642b10820db8f56000200000000000000000014"
                  >
