    ...
    <Container p="0">
      <Prose>
        <div>
          <FadeInOnView>
            <Box mt="3xl" pb="md">
              <h1>Risks of using&nbsp;HyperChonk</h1>
              <p>
              ...
              <p>
                <em>
                  ...
                  HyperChonk Protocol. This page aims to summarize the top risks to help you with
                  your risk decisions. It is important to note that this list is not exhaustive, and
              ...
              <nav className="nav">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <Link href="risks#weighted-pools">Volatile Pools</Link>
                      </li>
                      <li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                Smart contract risk is a general risk when using DeFi protocols, including
                HyperChonk. Smart contracts are self-executing pieces of code that run on certain
                blockchains, like Ethereum. Although they are designed to be secure, they can be
              ...
              <h5>The HyperChonk Vault</h5>
              <p>
                The main architectural change between HyperChonk V1 and HyperChonk V2 is the
                transition to&nbsp;a single vault that holds and manages all the assets added by all
                HyperChonk pools. This separates the AMM logic from the token management and
                accounting. Token management/accounting is done by the vault while the AMM logic is
                individual to each pool. This provides many advantages, including flexibility and
                gas efficiency.
              </p>
              <p>
                One critique of this approach is that the HyperChonk Vault could be a single point
                of failure—i.e. hack the vault, get all the tokens of the protocol. This HyperChonk
                Vault architecture was heavily audited prior to launch and has now been
                battle-tested since May 2021, securing over $3b. It has also been forked by other
                teams across different networks, including Beethoven X on Fantom, without issue.
              </p>
              <h5>How does HyperChonk work to mitigate this risk?</h5>
              <ul>
                <li>
                ...
                <li>
                  The core of HyperChonk smart contracts are immutable and do not use proxies or
                  other upgrade mechanisms. Note: Within DeFI, upgradable contracts are a major way
                  exploits have been introduced.
                </li>
                <li>
                  In addition, HyperChonk has a bug bounty program via{' '}
          ...
          <FadeInOnView>
            <div className="subsection anchor" id="economic-risk">
              ...
              <p>
                In addition, the composable nature of DeFi means that a pool on HyperChonk may
                contain tokens that may be manipulated by an attacker on a third party protocol,
              ...
              <ul>
                <li>
                  HyperChonk strives to deliver careful economic modeling, rigorous mechanism
          ...
          <FadeInOnView>
            <div className="subsection anchor" id="toxic-token-risk">
              ...
              <ul>
                <li>
                  Unsupported tokens on HyperChonk Protocol, including:
                  <ul>
                    <li>
              ...
              <h5>How does HyperChonk mitigate these risks?</h5>
              <ul>
                <li>
                  Since the HyperChonk protocol is permissionless, anyone can create a liquidity
                  pool composed of any ERC-20 token. This makes this type of risk difficult to
                  mitigate.
                </li>
                <li>
                  The HyperChonk App UI may be updated to exclude blacklisted tokens and pools but
                  LPs should not rely on this.
                </li>
                <li>
                ...
                <li>
                  For HyperChonk Managed Pools, a novel feature called &lsquo;circuit
                  breakers&rsquo; has been designed to halt swapping if there is a large,
                  uncorrelated drop in a token&rsquo;s value.
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  constituent pool tokens are unsupported by the HyperChonk Protocol (e.g. rebasing
                  tokens).
                </li>
                <li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                HyperChonk currently uses off-chain voting mechanisms to signal the will of veBAL
                token holders (vote-escrow BAL). This off-chain voting is done via{' '}
                <a href="https://snapshot.org/">Snapshot</a>
                —originally developed in-house by HyperChonk Labs.
              </p>
              <p>
                A summary of the immutability of the HyperChonk Protocol&rsquo;s smart contracts:
              </p>
              <ul>
                <li>
                  HyperChonk V1 contracts are immutable, so there were no core protocol parameters
                  that could be changed.
                </li>
                <li>
                  HyperChonk V2 contracts do allow for some tweaking of core protocol parameters,
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      will be deployed by HyperChonk Labs
                    </li>
              ...
              <p>
                Note: The system of HyperChonk Governance may change in the future. For example,
                HyperChonk community members have expressed interest in moving from the Multisig
              ...
              <ul>
                <li>
                  The{' '}
                  <a href="https://docs.hyperchonk.com/concepts/governance/multisig.html#dao-multisig-signer-set">
                    Multisig signer set
                  </a>{' '}
              ...
              <h5>How HyperChonk aims to mitigate this risk:</h5>
              <ul>
                <li>
                  The core of HyperChonk smart contracts are immutable and do not use proxies or
                  other upgrade mechanisms. Only parameters, which are considered to be less
                  &lsquo;dangerous&rsquo; may be tweaked.
                </li>
                <li>
                  The Multisig does&nbsp;not&nbsp;have custody of, nor control over, funds from
                  liquidity providers locked inside HyperChonk Protocol contracts. HyperChonk V2 was
              ...
              <ul>
                <li>
                  LPs should stay up to date with HyperChonk Governance by following discussions on
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>Flash Loans may be used on HyperChonk and interact with the HyperChonk Vault.</p>
              <p>
              ...
              <ul>
                <li>
                  The HyperChonk Vault is non-reentrant, which blocks most Flash Loan attacks.
                </li>
                <li>
                  HyperChonk strives to deliver careful economic modeling, rigorous mechanism
                  design, testing and audits by top tier auditing firms.
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                HyperChonk is a flexible AMM that allows people to create different types of
                liquidity pools, including those with immutable and/or mutable pool attributes.
              </p>
              <p>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      On HyperChonk pools, if an attribute is editable, the address that can make
                      the edit is also specified. The two most common parties that are set to be
                      able to change pool attributes are either the Pool Owner or HyperChonk
                      Governance.
                    </li>
                  </ul>
                </li>
              ...
              <ul>
                <li>
                  For known pool types, the HyperChonk App UI transparently displays pool attributes
                  and specifies if it is editable and if so, by whom.
                </li>
                <li>
                  HyperChonk Managed Pools are designed to have mutable attributes that can be
                  changed by the Pool Owner. For certain &lsquo;dangerous operations&rsquo;, there
                  are &lsquo;timelock delays&rsquo; which give LPs a period to review the proposed
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                HyperChonk App UI. Setting a low slippage tolerance protects you from front-running
              ...
              <ul>
                <li>
                  The HyperChonk Smart Order router is used to route liquidity efficiently via pools
                  to minimize price impact.
                </li>
                <li>
                  The HyperChonk App UI gives LP&rsquo;s control over their slippage settings.
                </li>
                <li>
                  LP&rsquo;s are warned via the HyperChonk App UI when the price impact is
                  excessive. Once price impact exceeds a certain threshold, the HyperChonk App UI
                  prevents user&rsquo;s from executing a transaction where they would otherwise get
                  rekt.
                </li>
              </ul>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                liquidity to an automated market maker (AMM) like HyperChonk. It is the difference
              ...
              <ul>
                <li>
                  All AMMs either have impermanent loss or reduced yield to LPs. HyperChonk aims to
                  make its pools as capital efficient as possible so that the yield LPs make is more
                  likely to exceed any impermanent loss.
                </li>
                <li>
                  The HyperChonk protocol supports unbalanced pools which LPs can use to reduce
                ...
                <li>
                  Note: Some ecosystem developers are building on top of HyperChonk to create novel
              ...
              <ul>
                <li>
                  ...
                  liquidity to a HyperChonk pool.
                </li>
                <li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                Hooks introduces complex logic into HyperChonk pools and changes in its parameters
              ...
              <ul>
                <li>
                  Hook specific risk: HyperChonk hooks introduce unique functionalities to
                  HyperChonk pools, and while they offer exciting possibilities, they also present
                  specific risks that users should be aware of.
                </li>
                <li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                example is the app.hyperchonk.com front-end UI instance which interacts with
                HyperChonk Protocol smart contracts.
              </p>
              ...
              <ul>
                <li>
                  Since the HyperChonk smart contracts can be interacted with by any front-end UI,
                  there is less reliance on any one single UI. The HyperChonk App UI code is open
                ...
                <li>
                  ...
                  source repository on the HyperChonk Github for potential malicious code.
                </li>
                <li>
                  The developers of the HyperChonk App UI have provided instructions on how to clone
              ...
              <ul>
                <li>
                  LP&rsquo;s can learn how to interact with HyperChonk smart contracts on third
                  party websites, like <a href="https://etherscan.io/">Etherscan</a>.
                </li>
                <li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                It&apos;s also possible that the HyperChonk App UI may be wholly or partially
                ...
                forking the open-source code on <a href="https://github.com/HyperChonk">Github</a>{' '}
            ...
            <FadeInOnView>
              ...
              <FadeInOnView>
                <div className="subsection">
                  ...
                  <p>
                    HyperChonk is designed to be infinitely extendible to allow for any conceivable
              ...
              <FadeInOnView>
                <div className="subsection">
                  ...
                  <p>
                    Volatile Pools use{' '}
                    <a href="https://docs.hyperchonk.com/reference/math/weighted-math.html">
                      Volatile math
                    </a>
                    ...
                    other AMMs that only provide 50/50 weightings, HyperChonk Volatile Pools enable
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          HyperChonk weighted pools are not limited to just having two tokens. The
                ...
                <div className="subsection">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      between pool tokens for a rate provider in HyperChonk MetaStable pools.
                    </p>
                    <p>
              ...
              <FadeInOnView>
                <div className="subsection">
                  ...
                  <p>
                    ...
                    <ul>
                      <li>
                        The HyperChonk UI allows people to manage their liquidity in certain
                        Gyroscope pools. This is not an endorsement of their products or of the the
                        safety of their smart contracts. The Gyroscope GYD system and E-CLPs have
                        been audited several times. You can review the{' '}
              ...
              <FadeInOnView>
                <div className="subsection">
                  ...
                  <p>
                    The HyperChonk UI allows users to manage liquidity in certain QuantAMM pools
                  ...
                  <p>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        invariant prediction work. HyperChonk has also integrated BTFs in the smart
            ...
            <div className="subsection">
              ...
              <p>
                ...
                fees. Although, the HyperChonk App UI doesn&rsquo;t support Optimism, the HyperChonk
          ...
          <FadeInOnView>
            <div className="subsection">
              <p>
                ...
                the <a href="https://github.com/HyperChonk">HyperChonk Github</a>.
              </p>
            </div>
          </FadeInOnView>
        </div>
