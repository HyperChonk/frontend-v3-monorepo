        ...
        <div className="pb-4">
          <FadeInOnView>
            <div className="subsection">
              <Box mt="3xl">
                <h1>HyperChonk Cookies&nbsp;Policy</h1>
                <p>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                This Cookies Policy (“Policy”) applies to your interaction with the HyperChonk
                Foundation, its subsidiary, HyperChonk OpCo Limited, and material service providers
                operating under a legal agreement (“HyperChonk Foundation,” “HyperChonk,” “we,”
                “our,” or “us”).
              </p>
            </div>
          </FadeInOnView>
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                HyperChonk.fi user interface (UI) to the HyperChonk Protocol. (“Sites” or “Site”).
              </p>
              <p>
