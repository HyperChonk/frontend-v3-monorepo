      ...
      <Prose>
        ...
        <FadeInOnView>
          <div className="subsection">
            <h2>1. Overview</h2>
            <p>
              This HyperChonk Terms of Use document (“Terms” or “agreement”) (“HyperChonk ”, “we”
              and “us” refers to the HyperChonk Foundation and its subsidiary HyperChonk OpCo
              Limited) covers the website, HyperChonk Protocol user-interface and free application
              (collectively “the Site”) we own and administer, at times in conjunction with others,
              which provides the ability to access the decentralized HyperChonk Protocol.
              Additionally, you can access the HyperChonk Protocol through third-party web or mobile
            ...
            <p>
              ...
              the HyperChonk Protocol and c) the online interface (UI) is a mere graphical interface
              for you to interact with the HyperChonk protocol, which can be accessed through other
            ...
            <p>
              ...
              the Terms. HyperChonk in its sole discretion, reserves the right to make changes to
              our Terms. Changes are binding on users of the Site and will take effect immediately
              upon posting. As a user, you agree to be bound by any changes, variations, or
        ...
        <FadeInOnView>
          <div className="subsection">
            <h2>2. Site</h2>
            <p>
              As part of the Site, HyperChonk provides access to a decentralized finance application
              (“Application” or “HyperChonk Protocol app”) on the Ethereum blockchain, that allows
              swappers or liquidity providers of Ethereum assets (“Cryptocurrency Assets”) to
              transact using smart contracts (“Smart Contracts”). Use of the HyperChonk Protocol may
              require that you pay a fee, such as gas charges on the Ethereum network to perform a
              transaction. You acknowledge and agree that HyperChonk has no control over any
              ...
              balance to complete any transaction on the HyperChonk Protocol before initiating such
            ...
            <p>
              <span className="italic font-semibold">
                You acknowledge and agree that HyperChonk has no control over any transactions
                conducted through the HyperChonk Protocol, the method of payment of any transactions
              ...
              cryptocurrency tokens stored at your HyperChonk Protocol-compatible wallet address
              (“Cryptocurrency Wallet”) to complete any transaction on the HyperChonk Protocol or
            ...
            <p>
              ...
              smart contracts that can be accessed via the HyperChonk user interface including,
              without limitation, the smart contracts for HyperChonk Pools. Before using these
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <ul>
              ...
              <li>
                Export, reexport, or transfer, directly or indirectly, any HyperChonk technology in
              ...
              <li>
                ...
                redirect or inhibit other users from fully enjoying the Site or the HyperChonk
                Protocol, or that could damage, disable, overburden, or impair the functioning of
                the Site or the HyperChonk Protocol in any manner;
              </li>
              <li>
                Attempt to circumvent or disable any content filtering techniques or security
                measures that HyperChonk employs on the Site, or attempt to access any service or
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <ul>
              <li>
                Losses while digital assets are being supplied to the HyperChonk Protocol and losses
              ...
              <li>
                Risks associated with accessing the HyperChonk Protocol through third party web or
              ...
              <li>
                Although HyperChonk does not have access to your assets, you are reminded and
                acknowledge that at any time, your access to your Cryptocurrency Assets through
                third party wallet services, unrelated to HyperChonk or the HyperChonk.Fi website,
            ...
            <ol>
              ...
              <li>
                that you expressly waive and release HyperChonk from any and all liability, claims,
              ...
              <li>
                ...
                holders of the HyperChonk Protocol governance token. No developer or entity involved
                in creating the HyperChonk Protocol will be liable for any claims or damages
                whatsoever associated with your use, inability to use, or your interaction with
                other users of, the HyperChonk Protocol, including any direct, indirect, incidental,
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <p>
              HyperChonk is the owner of all intellectual property rights in the Site and the
              material published on them. To the extent practical, these works are protected by
              copyright laws and all such rights are reserved. www.HyperChonk.fi is the uniform
              resource locator (`&apos;`URL`&apos;`) of HyperChonk. You will not make use of this
              URL (or any other URL owned by us) on another website or digital platform without our
              prior written consent. Any unauthorized use or reproduction may be prosecuted. You
              will retain ownership of all copyright in data you upload or submit by, through or to
              the Site. You grant us a worldwide, royalty-free, irrevocable license to use, copy,
          ...
          <div className="subsection">
            ...
            <p>
              <em className="font-semibold">
                ...
                constitutes an agreement to limit the liability of HyperChonk and our officers,
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <p>
              You agree to indemnify and hold HyperChonk and our officers, directors, employees,
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <p>
              ...
              you and us with respect to your use of the site, HyperChonk and the services provided
            ...
            <p>
              <em className="font-semibold">
                ...
                shall be Cayman Islands law or another choice of law determined in HyperChonk’s sole
                discretion.
              </em>
            </p>
            <p>
              <em className="font-semibold">
                ...
                claims. You agree that, by entering into this agreement, you and HyperChonk are each
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <p>
              ...
              occurrences such as emergency situations and force majeure events, HyperChonk is under
        ...
        <FadeInOnView>
          <div>
            <h2>12. Contact Us</h2>
            <p>
              HyperChonk is a foundation company organized in the Cayman Islands with an operating
              ...
              <a className="link" href="mailto:admin@hyperchonk.com">
                admin@hyperchonk.com
              </a>
              .
            </p>
          </div>
