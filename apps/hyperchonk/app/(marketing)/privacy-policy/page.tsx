        ...
        <div className="pb-4">
          <FadeInOnView>
            <div className="subsection">
              <Box mt="3xl">
                <h1>HyperChonk Foundation Privacy&nbsp;Policy</h1>
                <p>
              ...
              <p>
                <em className="font-medium">
                  This Privacy Policy explains how the HyperChonk Foundation, its subsidiary,
                  HyperChonk OpCo Limited (“HyperChonk Foundation,” “HyperChonk,” “we,” “our,” or
                  “us”) collects, uses, and discloses information about you. This Privacy Policy
                  applies when you use our website, HyperChonk Protocol user-interface or
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <ul>
                <li>
                  HyperChonk does not typically request, collect or use personal information. With
                  the exception of your wallet address, there is no reason for you to provide
                  personal information when you use the UI.
                </li>
                <li>
                  HyperChonk does not and has not stored personal information from users of the UI.
                  However, HyperChonk uses third party services including, without limitation,
                ...
                <li>
                  HyperChonk does not set any cookies. However, we use third party service providers
                  that set cookies.
                </li>
              </ul>
            </div>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                HyperChonk is not directed to children under the age of 16. If a parent or guardian
              ...
              <p>
                ...
                providers. Your wallet and IP address is accessible to HyperChonk and its vendor(s).
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <ul>
                <li>Ensure proper functioning of HyperChonk and the UI;</li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                described herein, in the normal course of HyperChonk business. However, when
                HyperChonk has access to personal information, such as your wallet and certain IP
                addresses, it may share that information in the following circumstances or as
              ...
              <ul>
                ...
                <li>
                  ...
                  of HyperChonk, the HyperChonk ecosystem, the public, or others.
                </li>
                <li>
                ...
                <li>
                  Personal information may be shared between and among HyperChonk and our current
                  and future parents, affiliates, and subsidiaries and other companies under common
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                HyperChonk Foundation is headquartered in the Cayman Islands with a subsidiary in
                the British Virgin Islands (BVI). Therefore, we and our service providers may
                transfer your personal information to, or store or access it in, jurisdictions that
                may not provide levels of data protection that are equivalent to those of your home
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <h3>Cookies</h3>
              <p>
                HyperChonk and its third party vendors may use any cookies to affect the
                availability and functionality of the UI. For more information about cookies and how
                to disable them, see our <Link href="cookies-policy">Cookies policy</Link>.
              </p>
            </div>
          </FadeInOnView>
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                HyperChonk does not “sell” personal information to advertise our products to you or
                otherwise.
              </p>
              ...
              <p>
                HyperChonk does not share such information with third parties for direct marketing
                purposes.
              </p>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                HyperChonk does not typically process user personal data. If HyperChonk processes
                data, such as a wallet address and certain IP addresses, it will do so in reliance
              ...
              <p>
                ...
                request that we restrict, certain processing. HyperChonk does not typically hold or
