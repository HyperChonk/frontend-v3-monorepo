...
export const lockingIncentivesTooltipText = `The protocol revenue share for Liquidity Providers
                                            with 1-year locked ${PROJECT_CONFIG.projectName} ve8020 tokens.`
...
const quantAMMTooltipText =
  "The annualized monthly uplift per LP token. The uplift is generated by the BTF strategy's dynamic rebalancing of the pool weights compared to a fixed weight pool. This uplift is shared with LPs proportionately."
