...
const partnerInfo: PartnerInfo = {
  [VebalRedirectPartner.Aura]: {
    ...
    description: `Aura Finance is a protocol built on top of the ${PROJECT_CONFIG.projectName} protocol to provide maximum incentives to ${PROJECT_CONFIG.projectName} liquidity providers and BAL stakers (into veBAL) through social aggregation of BAL deposits and via additional incentives of Aura's native token.`,
  ...
  [VebalRedirectPartner.StakeDAO]: {
    ...
    description: `Stake DAO is a key participant in veBAL through its 'Liquid Locker' product for BAL tokens. Stake DAO enables users and DAOs to lock BAL in the 80BAL/20WETH ${PROJECT_CONFIG.projectName} pool, minting sdBAL—a liquid wrapper that provides the benefits of veBAL for LPs (voting power, boosted rewards, and protocol fees) without sacrificing liquidity.`,
