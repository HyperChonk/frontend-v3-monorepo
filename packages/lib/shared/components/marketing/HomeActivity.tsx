      ...
      <Box m="0 auto" maxW="maxContent" pb="2xl" px={{ base: 'md', xl: '0' }}>
        <FadeInOnView>
          <Box m="auto" maxW="4xl" pb="xl" textAlign={{ base: 'left', md: 'center' }} w="full">
            ...
            >
              {PROJECT_CONFIG.projectName} is a vibrant ecosystem. Explore the latest activity
              across all {PROJECT_CONFIG.projectName} deployments including Ethereum, Arbitrum,
              Avalanche, and other L2 deployments.
            </Text>
