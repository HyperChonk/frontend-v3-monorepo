    ...
    <Section className="protocols">
      <Box m="0 auto" maxW="maxContent" px={{ base: 'md', xl: '0' }}>
        ...
        >
          <FadeInOnView>
            ...
            >
              Launch your token with confidence by plugging into the {PROJECT_CONFIG.projectName}{' '}
              vault and ecosystem. Find product market fit and generate revenue faster with
              liquidity and community from day 1.
            </Text>
          </FadeInOnView>
        </Box>
      </Box>
      ...
      <Box m="0 auto" maxW="maxContent">
        <FadeInOnView>
          <ParallaxImage>
            <Picture
              altText={`Pools plugged into ${PROJECT_CONFIG.projectName} vault`}
              defaultImgType="png"
              height="775"
              imgAvif
              imgAvifPortrait
        ...
        <FadeInOnView>
          <SimpleGrid columns={{ base: 2, md: 4 }} py="xl" spacing={{ base: 8, md: 8, xl: '12' }}>
            <Box>
              ...
              <Text>
                Access to the {PROJECT_CONFIG.projectName} vault for smart swap routing via your
                pools. Plus, fast track inclusion to aggregator partners.
              </Text>
            </Box>
            <Box>
              <Heading as="h5" pb="sm" size="h5" variant="h5">
            ...
            <Box>
              <Heading as="h5" pb="sm" size="h5" variant="h5">
                Access {PROJECT_CONFIG.projectName}&lsquo;s community
              </Heading>
              <Text>
                By building on {PROJECT_CONFIG.projectName}, LPs and swappers can find and / or
                interact with your AMM / pools via the ecosystem app.
              </Text>
            </Box>
            <Box>
              <Heading as="h5" pb="sm" size="h5" variant="h5">
