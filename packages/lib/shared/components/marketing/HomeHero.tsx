...
import { Box, Button, Flex, Heading, Link, Text, useToken, VStack } from '@chakra-ui/react'
              ...
              <Box py={{ base: 'xl', md: '2xl' }}>
                <Box h="24px">
                  <Text pb="lg" variant="eyebrow">
                    {PROJECT_CONFIG.projectName} DEX App
                  </Text>
                </Box>
                <Heading
                  fontWeight="normal"
                  ...
                  <Link href="/build/v3">
                    <Flex>
                      <Text background="font.special" backgroundClip="text" variant="eyebrow">
                        {PROJECT_CONFIG.projectName} protocol: v3 Soon&nbsp;
                      </Text>
                            ...
                            <VStack alignItems="flex-start" gap="0">
                              ...
                              <Box display="block" px="md" py="sm" role="group" w="full">
                                <Link
                                  ...
                                  href="https://docs.hyperchonk.com/"
                                >
                              ...
                              <Box display="block" px="md" py="sm" role="group" w="full">
                                <Link
                                  ...
                                  href="https://github.com/burrbear-dev/scaffold-balancer-v3"
                                >
                                  <Flex alignItems="center" gap="xxs">
                                    <Text
                                      _groupHover={{ color: 'font.maxContrast' }}
                                      ...
                                      whiteSpace="nowrap"
                                    >
                                      Scaffold {PROJECT_CONFIG.projectName} v3
                                    </Text>
                                    <ArrowUpRight display="inline" size={12} />
                                  </Flex>
                                  <Text
                                    ...
                                    whiteSpace="nowrap"
                                  >
                                    Prototyping tool for {PROJECT_CONFIG.projectName} v3
                                  </Text>
                                </Link>
                              </Box>
                              <Box display="block" px="md" py="sm" role="group" w="full">
