        ...
        >
          <FadeInOnView>
            ...
            <Text
              ...
              w="full"
            >
              {PROJECT_CONFIG.projectName} is a Decentralized Finance (DeFi) protocol that provides
              permissionless technology to streamline AMM development for developers and empower
              liquidity providers with an ever-expanding DEX product suite.
            </Text>
          </FadeInOnView>
        </Box>
            ...
            >
              ...
              <Card>
                <Flex direction="column" h="100%" justify="flex-end">
                  ...
                  >
                    Plug into {PROJECT_CONFIG.projectName}&lsquo;s veBAL incentive mechanism and
                    grants framework to bootstrap AMM liquidity.
                  </Text>
                </Flex>
              </Card>
              ...
              <Card gridArea={{ base: 'auto', md: '3 / 1 / 4 / 3', lg: '1 / 4 / 3 / 5' }}>
                <Flex direction="column" h="100%" justify="flex-end">
                  <Box h="100%" overflow="hidden" pb="md" rounded="lg">
                    ...
                    >
                      <Picture
                        altText={`The ${PROJECT_CONFIG.projectName} network`}
                        defaultImgType="jpg"
                        imgAvif
                        imgAvifDark
                        imgAvifPortrait
