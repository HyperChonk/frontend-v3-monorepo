...
function Stat({
  ...
  return (
    <Box
      flex="1"
      minW={{ base: '100px', sm: '150px', lg: '150px' }}
      overflow="hidden"
      position="relative"
      rounded="md"
      shadow="md"
    ...
    >
      <Box height="100%" position="absolute" width="100%">
        <Box
          ...
          width="100%"
          zIndex="-1"
          background={isHyperChonk ? 'background.level0' : 'white'}
        ></Box>
      </Box>
      <Box p="2">
        <Text
        ...
        <Text className="home-stats-main" fontSize="xl" letterSpacing="-0.6px" variant="special">
          {value}
        </Text>
      </Box>
    </Box>
