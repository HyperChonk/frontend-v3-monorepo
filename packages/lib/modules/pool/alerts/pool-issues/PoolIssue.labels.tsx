...
const emergencyMultisigLink = 'https://docs.hyperchonk.com/concepts/governance/emergency.html'

const vulnerabilityDisclosure = `This pool is affected by a disclosed vulnerability.`
const vulnerabilityDisclosureLink = 'https://forum.hyperchonk.com/t/vulnerability-disclosure/3179'
...
export const VulnerabilityDataMap: Record<PoolIssue, VunerabilityData> = {
  [PoolIssue.PoolProtocolFeeVulnWarning]: {
    ...
    learnMoreLink: `https://x.com/${PROJECT_CONFIG.projectName}/status/1611363559685898247`,
  },
    ...
    jsxTitle: (
      <>
        ...
        <Link
          ...
          color="font.dark"
          href="https://forum.hyperchonk.com/t/vulnerability-disclosure/3179"
          rel="noreferrer"
          target="blank"
        >
          vulnerability
        ...
        <Link
          _hover={{ color: 'font.maxContrast' }}
          color="font.dark"
          href="https://app.hyperchonk.com/#/ethereum/pool/0xa13a9247ea42d743238089903570127dda72fe4400000000000000000000035d"
          rel="noreferrer"
          target="blank"
        >
          upgraded pool{' '}
