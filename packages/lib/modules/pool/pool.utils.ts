...
export const chainToSlugMap: Record<GqlChain, ChainSlug> = {
  ...
  [GqlChain.HyperevmTestnet]: ChainSlug.HyperEvmTestnet,
  [GqlChain.Berachain]: ChainSlug.Berachain,
}
...
const poolTypeLabelMap: { [key in GqlPoolType]: string } = {
  ...
  [GqlPoolType.MetaStable]: 'Multi Stable',
  [GqlPoolType.PhantomStable]: 'Multi Stable',
  [GqlPoolType.Stable]: 'Multi Stable',
  [GqlPoolType.Unknown]: 'Unknown',
  [GqlPoolType.Fx]: 'RWA',
  [GqlPoolType.ComposableStable]: 'Multi Stable',
